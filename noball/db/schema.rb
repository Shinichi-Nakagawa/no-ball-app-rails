...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "AllstarFull", id: false, force: true do |t|
    t.string  "playerID",    limit: 9,  null: false
  ...
  create_table "AwardsManagers", id: false, force: true do |t|
    t.string  "playerID", limit: 9,   null: false
    t.string  "awardID",  limit: 25,  null: false
    t.integer "yearID",               null: false
  ...
  create_table "AwardsSharePlayers", id: false, force: true do |t|
    ...
    t.string  "lgID",       limit: 2,  null: false
    t.string  "playerID",   limit: 9,  null: false
    t.float   "pointsWon",  limit: 53
    t.integer "pointsMax"
    t.float   "votesFirst", limit: 53
  end
  ...
  create_table "BattingTotal", id: false, force: true do |t|
    t.string  "playerID",  limit: 9, null: false
    t.integer "yearID",              null: false
    t.integer "G"
    t.integer "G_batting"
  ...
  create_table "Master", primary_key: "playerID", force: true do |t|
    ...
    t.string  "debut",        limit: 10
    t.string  "finalGame",    limit: 10
    t.string  "college",      limit: 50
    t.string  "lahman40ID",   limit: 9
    t.string  "lahman45ID",   limit: 9
    t.string  "retroID",      limit: 9
    t.string  "holtzID",      limit: 9
  ...
  create_table "PitchingTotal", id: false, force: true do |t|
    t.string  "playerID", limit: 9, null: false
    t.integer "yearID",             null: false
    t.integer "W"
    t.integer "L"
  ...
  create_table "SalariesTotal", id: false, force: true do |t|
    t.integer "yearID",              null: false
    t.string  "playerID", limit: 9,  null: false
    t.float   "salary",   limit: 53
  end
  ...
  create_table "Schools", primary_key: "schoolID", force: true do |t|
    t.string "schoolName"
    t.string "schoolCity",  limit: 55
    t.string "schoolState", limit: 55
    t.string "schoolNick",  limit: 55
  end

  create_table "SchoolsPlayers", id: false, force: true do |t|
    t.string  "playerID", limit: 9,  null: false
    t.string  "schoolID", limit: 15, null: false
    t.integer "yearMin"
    t.integer "yearMax"
  end
  ...
  create_table "SeriesPost", id: false, force: true do |t|
    t.integer "yearID",                 null: false
    t.string  "round",        limit: 5, null: false
  ...
  create_table "TeamsHalf", id: false, force: true do |t|
    ...
    t.string  "lgID",   limit: 2, null: false
    t.string  "teamID", limit: 3, null: false
    t.string  "Half",   limit: 1, null: false
    t.string  "divID",  limit: 1
    t.string  "DivWin", limit: 1
    t.integer "Rank"
    t.integer "G"
